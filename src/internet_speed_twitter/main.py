...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        go_button.click()
        time.sleep(60)
        self.up = self.driver.find_element_by_xpath('//*[@id="container"]/div/div[3]/div/div/div/div[2]/div'
                                                    '[3]/div[3]/div/div[3]/div/div/div[2]/div[1]/div[2]/div'
                                                    '/div[2]/span').text
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(5)
        tweet_compose = self.driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/div'
